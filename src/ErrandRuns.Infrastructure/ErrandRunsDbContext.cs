...
public sealed class ErrandRunsDbContext(DbContextOptions<ErrandRunsDbContext> options):DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<RunnerProfile>(e=>{e.ToTable("RunnerProfiles","runners");e.HasKey(x=>x.UserId);e.Property(x=>x.Rating).HasPrecision(3,2);e.HasIndex(x=>x.Status);});
