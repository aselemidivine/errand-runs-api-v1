...
public sealed class ErrandTests
{
    ...
    [Fact] public void Paid_errand_cannot_be_deleted() { var e=New();e.AddStop(Stop(1,StopType.Task));e.RequestEstimate();e.SetEstimate();e.ConfirmPayment();Assert.Throws<DomainException>(e.EnsureCanDeleteUnpaid); }
